...
public class SurvivalAltEnemyAI : MonoBehaviour
{
    ...
    [FormerlySerializedAs("climbDuration")]
    ...
    [System.Obsolete("Climb duration has been replaced by climbSpeed.")]
    private float climbDuration => climbSpeed <= 0f ? 0f : 1f / climbSpeed;
